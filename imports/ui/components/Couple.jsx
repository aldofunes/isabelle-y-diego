  ...
  fiancees() {
    return [
      ...
      },
      {
        ...
        description: 'Las largas jornadas de trabajo, los viajes de negocio, los partidos de ' +
        'futbol americano (y de futbol soccer, y de baseball, y de basketball, etc.), el P.A.N., ' +
        'los ronquidos, la capacidad de dormirse en cualquier lugar en cualquier momento, los ' +
        'gadgets tecnológicos, los relojes marca “Polar”, y las camisas blancas con corbata y ' +
        'mancuernillas: ¡es él!\n\n' +

        'Sus actividades predilectas: el golf, la bici en Malinalco, trabajar (“contestar el ' +
        'teléfono” dirían sus hijas), los desayunos-comidas-cenas entre semana tanto ' +
        'profesionales como amistosos , planear los viajes (no hay como él para reservar hoteles,' +
        ' coche, espectáculos, excursiones), leer estadísticas de futbol americano, sacar fotos ' +
        '(¡pero muchas!) y grabar videos de los acontecimientos familiares\n\n' +

        'Lo que no puede faltar en su casa: una mega pantalla para ver partidos de futbol, ' +
        'chocolates (pasitas cubiertas de chocolate entre otros), … y un teléfono para pedir ' +
        'auxilio en caso de tener que realizar cualquier actividad manual en la casa\n\n' +

        'Es un hombre muy afortunado: siempre ha soñado con despertar con varias mujeres ' +
        'francesas en su cama…. ¡Sueño cumplido! Y es el único profesionista que a donde ' +
        'viaje se encuentra un evento deportivo a donde ir, y es más: ¡a donde lo invitan!',
      },
    ];
  }
